...
def AAINDEX(fastas, **kw):
	...
	fileAAindex = re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[0]) + r'data\HQI18.txt' if platform.system() == 'Windows' else re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[0]) + 'data/HQI18.txt'
